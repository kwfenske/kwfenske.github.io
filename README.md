...
Copyright &copy; 2011-2019 by Keith Fenske. Send e-mail
...
- [Handling Digital Photo Files](handling-digital-photo-files.pdf) (PDF, 50
KB): General advice for collecting digital photos. Read it or don't. After a
few thousand files, you really should do something!
...
- [Alphabet Web Icons](alphabet-web-icons.zip) (ICO in ZIP, 203 KB): Outline
letters and digits as program icons for Microsoft Windows or as "favicon.ico"
files on web pages (bookmark icons).

- [Generic Icon](generic-program-icon.zip) (ICO in ZIP, 20 KB): A placeholder
for when you need an icon but don't have time yet to design a new one.

- [Happy Face Icon](happy-face-icon.zip) (ICO in ZIP, 19 KB): Brighten up the
...
- [Size Test Icon](size-test-icon.zip) (ICO in ZIP, 27 KB): Way back when in
...
Java software on this web site is free and has been released under the [GNU
General Public License](https://www.gnu.org/licenses/licenses.html) (GPL). The
same Java programs will run on Linux, MacOS, Windows, etc. You may need to
...
- [Character Map](character-map-java.zip) (Java, ZIP, 1118 KB): CharMap is a
...
- [Compare Folders](compare-folders-java.zip) (Java, ZIP, 297 KB):
...
- [Drive Speed](drive-speed-java.zip) (Java, ZIP, 210 KB): DriveSpeed is a Java
...
- [Erase Disk](erase-disk-java.zip) (Java, ZIP, 231 KB): EraseDisk is a Java
...
affected. Don't trust a new drive until you write data, then read to confirm.
One complete test is usually enough. (Repeated testing may degrade flash
drives.)

- [File Checksum](file-checksum-java.zip) (Java, ZIP, 217 KB): FileChecksum is
...
ZIP file is a70ec180b32b34b5bd45227d04ee8989.

- [File Redate Rename](file-redate-rename-java.zip) (Java, ZIP, 225 KB):
...
- [Find Duplicate Files](find-duplicate-files-java.zip) (Java, ZIP, 202 KB):
...
- [Font Rename](font-rename-java.zip) (Java, ZIP, 265 KB): FontRename is a Java
...
- [Hex File Viewer](hex-file-viewer-java.zip) (Java, ZIP, 212 KB): HexView is a
...
- [Icon Editor](icon-editor-java.zip) (Java, ZIP, 262 KB): IconEdit is a Java
...
Small Java utility programs, also released under the GNU GPL. If these aren't
what you want, edit and recompile. See program comments and/or command-line
help for information.

- [Check Plain Trim](check-plain-trim-java.zip) (Java, ZIP, 210 KB):
...
- [Largest Files](largest-files-java.zip) (Java, ZIP, 152 KB):
LargestFiles is a Java 1.4 console application to find the biggest files in a
list of file or folder names given on the command line. The code is a template
for simple applications that process files, folders, and subfolders. See also:
[Show File Size](show-file-size-java.zip),
[Show Folder Size](show-folder-size-java.zip).

- [Random Password](random-password-java.zip) (Java, ZIP, 193 KB):
...
- [Redate Photo File](redate-photo-file-java.zip) (Java, ZIP, 219 KB):
...
- [Trim File](trim-file-java.zip) (Java, ZIP, 172 KB): TrimFile is a Java 1.4
...
[Hex Text Applet](https://github.com/kwfenske/hex-text-applet-java),
...
was last revised on Tuesday, 31 December 2019. Copyright &copy; 2011-2019 by
